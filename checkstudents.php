...
<body>
    ...
    <!--HOME SECTION END-->
     ...
     if (isset($_POST['submit'])) {
         ...
         //query
         $sql="SELECT nom_user, COUNT(*) as total
         FROM students
          where nom_user='$keyword'";
         $result = mysqli_query($link,$sql);
         $values=mysqli_fetch_assoc($result);
         $total=$values['total'];
         $query = mysqli_query($link,"SELECT * FROM `students` WHERE nom_user='$keyword'");
         if ($total > 0) {
             while ($row = mysqli_fetch_array($query)) {
                ...
                echo "<table>";
                 ...
                 echo "<td> <a href=afficher.php?login_user=".$login.">Afficher</a></td>";
                 echo " <td> <a href=delete.php?login_user=".$login.">delete</a></td>";
                 echo " </tr>";
                 echo "</table> ";
