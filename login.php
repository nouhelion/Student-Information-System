...
<div class="Container">
        ...
        <div class="panels-container">
            <div class="panel panel-left">
                <div class="content">
                    <button class="btn Transparent" id="sign-up-button"><a href="register.php">Sign Up</a></button>
                </div>
  ...
  <script src="https://unpkg.com/ionicons@5.4.0/dist/ionicons.js"></script>
    ...
    if(isset($_POST['username'])){
        ...
        $query = "SELECT * FROM `students` WHERE login_user='$username' and password_user='$password'";
